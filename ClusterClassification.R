...
#Non-Random Patterns in the Data
      ...
      #Clustering consists of grouping a set of objects in such a way that objects
      #in the same group or cluster are more similar to each other than to those in
      #other clusters.  "Similar" is specifically defined. 
            ...
            #Clustering is in the "eye of the beholder" - and art in large part.

  #The goals can differ: in Business Analytics we are typically interested in 
  #the resulting groups. In other fields, such as imaging or automatic
  #classification, the focus is on the resulting discriminative power of the 
  # clusters identified.

        # The choice of an appropriate distance metric will influence the shape of the clusters;
        # Some elements may be close to one another according to one distance and
        # farther away according to another.

#If the variables are measured on different scales they should be
#standardized. This step, however, is not settled; some argue against normalizing.

# Clustering is an Unsupervised Classification method because you don't have 
# any prior classification/response variable associated with your data

# But today - for pedagogical purposes - we learn clustering 
# by resorting to comparing our results to known
# categories - taking a page out of the Supervised Classification playbook.
# This is the reason for titling the script Cluster Classification

    # In this lesson: the K-means algorithm, testing for clusterability, representing
    # results visually, the relevance of standardization and feature importance.
